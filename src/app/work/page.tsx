                ...
                <div className="p-8 sm:p-10">
                  ...
                  {project.github && (
                    <a
                      ...
                      className="mb-5 inline-flex items-center gap-2 rounded-full border border-border bg-background px-4 py-2 text-sm font-medium text-muted transition-colors hover:border-accent-dim hover:text-foreground"
                    >
